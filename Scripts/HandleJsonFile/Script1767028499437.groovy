...
import services.EmployeeCsvService
import services.EmployeeFilterService
import services.EmployeeJsonService
import utils.CSVUtil

import org.openqa.selenium.Keys as Keys

// File Json local
String jsonPath = "C:/Luong/Code/GroovyExercises/Data Files/JsonDataManual.json"

// =========== Handle file ===============
// Read all employees from json file
def employees = EmployeeJsonService.readEmployees(jsonPath)
println "Number of employees: ${employees.size()}"
println "Detail employess ${employees}"

// Read the exchange rate from json file
def rate = new ExchangeRate(usd: 1, vnd: EmployeeJsonService.readUsdToVndRate(jsonPath))
println "Rate: ${rate}"
...
EmployeeCsvService.exportEmployeesToCsv("Data Files/CsvEmployeeDataByJson.csv", employees)
EmployeeCsvService.exportExchangeRateToCsv("Data Files/CsvExchangeRateDataByJson.csv", rate)