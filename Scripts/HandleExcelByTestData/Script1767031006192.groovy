...
import services.TestDataEmployeeExcelService
import utils.JSONUtil

import org.openqa.selenium.Keys as Keys

// ========================== HANDLE FILE EXCEL BY TEST DATA IN KATALON ========================
// Read all employees from excel file
def employees = TestDataEmployeeExcelService.readEmployees("Data Files/ExcelEmployeeData")
println "Number of employees: ${employees.size()}"
println "Detail employess ${employees}"

// Read the exchange rate from excel file
def rate = TestDataEmployeeExcelService.readExchangeRate("Data Files/ExcelExchangeRateData")
println "Rate: ${rate}"
...
JSONUtil.writeJsonToFile(payload, "Data Files/JsonDataByTestData.json")