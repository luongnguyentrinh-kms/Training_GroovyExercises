...
String excelPath = Paths.get(dataFolder, 'EmployeeData.xlsx').toString()

'Open excel file'
Workbook wb = ExcelUtil.openWorkbook(excelPath)

'Read employees from excel file'
def employees = EmployeeDataService.readEmployeesFromExcel(wb)
...
JSONUtil.writeJson(payload, jsonPath)
